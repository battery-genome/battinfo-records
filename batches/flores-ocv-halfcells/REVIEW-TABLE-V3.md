...
| test-protocol | 4 | 4 | 4 | identifiers held; byte-identical. |
| test | 95 | 95 | 95 | 48 identifiers held, 47 re-seeded; rounded per-cell conditions. |

Record by record against v2: 114 byte-identical, 65 changed under the same identifier, 147 new files, 144 files removed (the re-seeded identities).
